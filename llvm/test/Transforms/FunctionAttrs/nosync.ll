...
; FNATTR: Function Attrs: norecurse nounwind uwtable
; FNATTR-NEXT: define void @foo1(i32 *, %"struct.std::atomic"*)
; ATTRIBUTOR: Function Attrs: norecurse nounwind uwtable
; ATTRIBUTOR-NOT: "nosync"
; ATTRIBUTOR-NEXT: define void @foo1(i32 *, %"struct.std::atomic"*)
...
; FNATTR: Function Attrs: norecurse nounwind uwtable
; FNATTR-NEXT: define void @bar(i32 *, %"struct.std::atomic"*)
; ATTRIBUTOR: Function Attrs: norecurse nounwind uwtable
; ATTRIBUTOR-NOT: "nosync"
; ATTRIBUTOR-NEXT: define void @bar(i32 *, %"struct.std::atomic"*)
